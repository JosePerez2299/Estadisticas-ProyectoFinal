...
par(mfrow = c(2, 4))
boxplot(y, main = "Diagrama de cajas de y", col = "yellow", horizontal = F, xlab = "y")
boxplot(x1, main = "Diagrama de cajas de x1", col = "blue", horizontal = F, xlab = "x1")
boxplot(x2, main = "Diagrama de cajas de x2", col = "red", horizontal = F, xlab = "x2")
boxplot(x3, main = "Diagrama de cajas de x3", col = "orange", horizontal = F, xlab = "x3")
boxplot(x4, main = "Diagrama de cajas de x4", col = "green", horizontal = F, xlab = "x4")
boxplot(x5, main = "Diagrama de cajas de x5", col = "purple", horizontal = F, xlab = "x5")
boxplot(x7, main = "Diagrama de cajas de x7", col = "white", horizontal = F, xlab = "x7")
boxplot(x8, main = "Diagrama de cajas de x8", col = "gray", horizontal = F, xlab = "x8")
dev.off()
